...
function QuatroEmLinha() {
	...
	//Funcao inicial do jogo iniciação da matriz e variáveis.
    ...
    this.mensagemGanhador = function (jogador) {
        ...
        var alerta = "";
        if (jogador < 0) {
            alerta = "Pareçe que o computador foi mais inteligente...";
			} else if (jogador > 0) {
	...
	//Funções responsáveis pela parte gráfica.
...
function escreveValores(){
	console.log("Listagem execução de chamadas de funções:");	
